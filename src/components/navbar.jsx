...
export default function NavBar() {
  ...
  return (
    <nav className="fixed top-0 z-10 w-full border border-zinc-700/45 bg-background">
      <div className="items-center px-3 py-4 m-auto lg:max-w-screen-xl md:max-w-screen-md">
        ...
        <div
          className={`${
            !menu ? "hidden" : ""
          } mobile-menu p-4 space-y-2 bg-accent border border-zinc-700 rounded-lg mt-4`}
        >
